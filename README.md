...
* There's also a hex editor view, meant to help with developing this program. When viewing an .anb file it shows where the parser thinks the various structs are in the file, and clicking on them shows a debug print of their contents.
