...
* There's also a hex editor view, meant to help with developing this program. It currently has rudimentary functionality for debugging .pak and .anb parsing, but I'm starting to think it might be more trouble than it's worth... trying to find a good way to implement this is sucking away all the development time that could be spent on primary functionality.
